loc=[1.2222,0.3344] %ONLY FOR TESTS
d=[];
r=[];
b=[];
x_mic=[];
...
d(1)=sqrt((loc(1)-mic1(1))^2+(loc(2)-mic1(2))^2)
d(2)=sqrt((loc(1)-mic2(1))^2+(loc(2)-mic2(2))^2)
d(3)=sqrt((loc(1)-mic3(1))^2+(loc(2)-mic3(2))^2)
d(4)=sqrt((loc(1)-mic4(1))^2+(loc(2)-mic4(2))^2)
d(5)=sqrt((loc(1)-mic5(1))^2+(loc(2)-mic5(2))^2)
